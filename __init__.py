...
''' Simple use of ANSI escape codes with Python. 
...
This package provides two methods:
    - `ansi_format(string, **kwargs)` which returns a string preceeded by the
      ANSI-codes implementing the specifications passed as keyword arguments
      and followed by the code to reset the output format,
...
**kwargs
    Instructions for formatting the string, with values in the following
    table:
    +---------------+-----------------------------------+------------+
...
__copyright__ = "Gabriel Pelouze 2015"
__license__ = "GPL v3"
